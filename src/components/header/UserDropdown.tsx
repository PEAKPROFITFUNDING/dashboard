    ...
    <div className="relative">
      ...
      >
        ...
        <Button
          ...
          className="flex items-center gap-3 mt-3 font-medium text-gray-200 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
            className="fill-gray-300 group-hover:fill-gray-700 dark:group-hover:fill-gray-300"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
